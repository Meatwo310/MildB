...
object ModConfig {
    ...
    // Mod Properties
    const val MOD_ID = "mildb"
    const val MOD_NAME = "MildB"
    const val MOD_LICENSE = "GNU GPL 3.0"
    const val MOD_VERSION = "1.0.0"
    const val MOD_GROUP_ID = "net.meatwo310.$MOD_ID"
    const val MOD_AUTHORS = "Meatwo310"
    const val MOD_DESCRIPTION = "Superb Warfare without \"B\""
